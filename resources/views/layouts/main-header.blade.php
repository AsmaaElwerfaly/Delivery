					...
					<div class="dropdown-menu">
						<div class="menu-header-content bg-primary text-right">
							<div class="d-flex">
								...
								<span class="badge badge-pill badge-danger mr-auto my-auto float-left">{{Auth::user()->unreadNotifications->count()}}</span>
							</div>
							<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 " >   لديك {{Auth::user()->unreadNotifications->count()}}  جديده اشعارات</p>
						</div>
